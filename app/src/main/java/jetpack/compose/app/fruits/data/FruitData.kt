...
import jetpack.compose.app.fruits.ui.theme.*
...
val fruitData: Array<Fruit> = arrayOf(
    Fruit(
        ...
        gradientColors = arrayOf(ColorBlueberryLight, ColorBlueberryDark),
        description = """
    ...
    Fruit(
        ...
        gradientColors = arrayOf(ColorStrawberryLight, ColorStrawberryDark),
        description = """
    ...
    Fruit(
        ...
        gradientColors = arrayOf(ColorLemonLight, ColorLemonDark),
        description = """
    ...
    Fruit(
        ...
        image = R.drawable.plum,
        gradientColors = arrayOf(ColorPlumLight, ColorPlumDark),
        description = """
    ...
    Fruit(
        ...
        gradientColors = arrayOf(ColorLimeLight, ColorLimeDark),
        description = """
    ...
    Fruit(
        ...
        gradientColors = arrayOf(ColorPomegranateLight, ColorPomegranateDark),
        description = """
    ...
    Fruit(
        ...
        gradientColors = arrayOf(ColorPearLight, ColorPearDark),
        description = """
    ...
    Fruit(
        title = "Gooseberry",
        headline = "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image = R.drawable.gooseberry,
        gradientColors = arrayOf(ColorGooseberryLight, ColorGooseberryDark),
        description = """
    ...
    Fruit(
        ...
        gradientColors = arrayOf(ColorMangoLight, ColorMangoDark),
        description = """
    ...
    Fruit(
        ...
        gradientColors = arrayOf(ColorWatermelonLight, ColorWatermelonDark),
        description = """
    ...
    Fruit(
        ...
        gradientColors = arrayOf(ColorCherryLight, ColorCherryDark),
        description = """
    ...
    Fruit(
        ...
        gradientColors = arrayOf(ColorGrapefruitLight, ColorGrapefruitDark),
        description = """
    ...
    Fruit(
        ...
        gradientColors = arrayOf(ColorAppleLight, ColorAppleDark),
        description = """
